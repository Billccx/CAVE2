...
from calculators.FaceYoloCuda.utils.general import non_max_suppression, make_divisible, scale_coords, xyxy2xywh
from calculators.FaceYoloCuda.utils.plots import color_list
